...
long.data <- read.csv("https://raw.githubusercontent.com/adam-scherr/Oak-Spongy-Project/refs/heads/main/Summer2025_ClearVanes/Clear%20Vane%20Sample%20Order%20IDs_Summer2025.csv")
